...
const ImgSlider = () => {
  ...
  return (
    <div name="home" className="relative pb-4">
      <div>
        {sliderData.map((item) => {
          return (
            <div
          ...
          return (
            <div className="mr-4" key={dot.id}>
              <div
                className={
                  index === slideIndex
                    ? "bg-[#f7b614] rounded-full p-2 cursor-pointer"
      ...
      <div>
        <button
          className="absolute top-[50%] right-4 bg-white rounded-full p-2 hover:bg-[#f7b614]"
        ...
        <button
          className="absolute top-[50%] left-4 bg-white rounded-full p-2 hover:bg-[#f7b614]"
